...
class WalkForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'distance': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'Distance (km)', 'min': '0', 'step': '0.1'}),
            'time_hours': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'Hours', 'min': '0', 'step': '1'}),
            'time_minutes': forms.NumberInput(attrs={'class': 'form-control', 'placeholder': 'Minutes', 'min': '0', 'max': '59', 'step': '15'}),
